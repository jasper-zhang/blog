...
www_path = '/home/jasper/selfblog'
supervisord_bin_path = '/home/jasper/bin'
supervisord_conf_file = '/home/jasper/conf/supervisord.conf'
...
@roles('server')
def re_mem():
    run("ps aux|grep 'jasper/memcached' | grep -v 'grep' | awk '{print $2}' | xargs kill -9")
    run("memcached -d -m memory -s /home/jasper/memcached.sock -P /home/jasper/memcached.pid")
